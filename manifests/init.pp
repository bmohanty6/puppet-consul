...
class consul (
  ...
  $download_url      = "https://releases.hashicorp.com/consul/0.4.1/consul_0.4.1_linux_amd64.zip",
  $package_name      = $consul::params::package_name,
  $package_ensure    = $consul::params::package_ensure,
  $ui_download_url   = "https://releases.hashicorp.com/consul/0.4.1/consul_0.4.1_web_ui.zip", 
